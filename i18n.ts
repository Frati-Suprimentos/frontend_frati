...
const translations: TranslationMap = {
  "pt-BR": {
    ...
    "hero.titleDesktop": "A MAIS COMPLETA LINHA DE<br>MATERIAIS PARA ELEVAÇÃO,<br>AMARRAÇÃO E MOVIMENTAÇÃO<br>DE CARGA",
    "hero.titleMobile": "A MAIS COMPLETA<br>LINHA DE MATERIAIS<br>PARA ELEVAÇÃO,<br>AMARRAÇÃO E<br>MOVIMENTAÇÃO DE<br>CARGA",
  ...
  "en-US": {
    ...
    "hero.titleDesktop": "THE MOST COMPLETE LINE OF<br>MATERIALS FOR LIFTING,<br>LASHING AND LOAD<br>HANDLING",
    "hero.titleMobile": "THE MOST COMPLETE<br>LINE OF MATERIALS<br>FOR LIFTING,<br>LASHING AND<br>LOAD HANDLING",
